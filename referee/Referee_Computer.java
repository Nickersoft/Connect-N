...
//	BufferedReader input = new BufferedReader(new InputStreamReader(System.in));
	...
	public Referee_Computer( String command_to_execute_player1, String command_to_execute_player2, int board_height,int board_width, int N, int announceNameTimeLimit, 	int moveTimeLimit) throws IOException{
...
//	}
	...
	public static void main(String [] arg) throws IOException{
		...
		Referee_Computer ref=new Referee_Computer( command_to_execute_player1, command_to_execute_player2, board_height, board_width,  N,  announceNameTimeLimit,  moveTimeLimit);
